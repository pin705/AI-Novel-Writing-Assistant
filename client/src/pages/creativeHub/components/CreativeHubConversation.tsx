    ...
    >
      <AssistantRuntimeProvider runtime={runtime}>
        <Card className="flex h-full min-h-0 flex-col">
          <CardHeader>
            <CardTitle className="text-base">Trung tâm sáng tác</CardTitle>
          </CardHeader>
            ...
            <ThreadPrimitive.Root className="flex min-h-0 flex-1 flex-col space-y-4">
              <ThreadPrimitive.Viewport className="min-h-0 flex-1 space-y-4 overflow-y-auto rounded-2xl bg-gradient-to-b from-slate-50 to-slate-100/70 p-4 ring-1 ring-slate-200">
                <ThreadPrimitive.Empty>
                  <div className="mx-auto mt-8 max-w-[680px] px-2 text-center">
                    <h3 className="text-4xl font-semibold tracking-tight text-slate-900">Trung tâm sáng tác</h3>
                    <p className="mt-2 text-lg text-slate-500">Hãy ném vấn đề sáng tác đang làm bạn kẹt vào đây, mình sẽ giúp bạn đánh giá, bóc tách rồi mới quyết định có bước vào triển khai hay không.</p>
                    {onQuickAction ? (
              ...
              <ComposerPrimitive.Root className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
                <ComposerPrimitive.Input
                  ...
                  placeholder="Mô tả vấn đề của tác phẩm, điểm bạn đang lưỡng lự, hoặc vòng sáng tác muốn đẩy tiếp; Enter để gửi, Shift+Enter để xuống dòng."
                  submitMode="enter"
                />
